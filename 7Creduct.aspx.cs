...
{
    public partial class _7Creduct : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                cnn.Open();
                SqlCommand cmd2 = new SqlCommand("Select netWeight from stock where material='7C' and wash='Wash'", cnn);
                SqlCommand cmd3 = new SqlCommand("Select netWeight from stock where material='7C' and wash='Non-Wash/High-EC'", cnn);
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                String sql = "Select netWeight from stock where material='7C' and wash='" + selval + "'";
                ...
                {
                    SqlCommand cmd1 = new SqlCommand("Update stock set netWeight='" + vallast + "'where material='7C' and wash='" + selval + "'", con);
                    ...
                    cmd2.Parameters.AddWithValue("@material", "7c");
