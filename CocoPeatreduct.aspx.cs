...
{
    public partial class CocoPeatreduct : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                cnn.Open();
                SqlCommand cmd2 = new SqlCommand("Select netWeight from stock where material='Coco-Peat' and wash='Low-EC(ec<500)'", cnn);
                SqlCommand cmd3 = new SqlCommand("Select netWeight from stock where material='Coco-Peat' and wash='Low-EC(500-1500)'", cnn);
                SqlCommand cmd4 = new SqlCommand("Select netWeight from stock where material='Coco-Peat' and wash='Non-Wash/High-EC'", cnn);
                SqlCommand cmd5 = new SqlCommand("Select netWeight from stock where material='Coco-Peat' and wash='Super-Wash'", cnn);
                //SqlDataReader dr = cmd.ExecuteReader();
                //dr.Read();
                TextBox2.Text = cmd2.ExecuteScalar().ToString() + " Kg ";
                TextBox3.Text = cmd3.ExecuteScalar().ToString() + " Kg ";
                TextBox4.Text = cmd4.ExecuteScalar().ToString() + " Kg ";
                TextBox5.Text = cmd5.ExecuteScalar().ToString() + " Kg ";
                //dr.Close();
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                String sql = "Select netWeight from stock where material='Coco-Peat' and wash='" + selval + "'";
                ...
                {
                    SqlCommand cmd1 = new SqlCommand("Update stock set netWeight='" + vallast + "'where material='Coco-Peat' and wash='" + selval + "'", con);
                    ...
                    cmd2.Parameters.AddWithValue("@material", "Coco-Peat");
