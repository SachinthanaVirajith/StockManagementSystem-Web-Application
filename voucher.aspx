...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class"row">
        <div class="col-sm-10">
            <asp:Label ID="Label2" runat="server" Text="Managing Director decide Net Weight as :"></asp:Label>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-10">
            <asp:TextBox ID="cutNetWeighttxt" runat="server" ReadOnly="true" Width="360px" class="form-control" BorderColor="#C48A05" BorderWidth="2px"></asp:TextBox>
        </div>
    </div>
    <br />
    <br />
    ...
    <div class="col-sm-4">
      <asp:Label ID="lblChq" runat="server" Text="Cheque:"></asp:Label>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <asp:TextBox ID="txtChqNo" runat="server"  class="form-control" BorderColor="#C48A05" BorderWidth="2px" Placeholder="Cheque No" Width="259px" AutoComplete="off"></asp:TextBox>
    </div>
    </div>
    <br />
    <br />
    ...
    <div class="row">
     <div class="col-sm-2">
          <asp:Label ID="Label3" runat="server" Text="Reduction"></asp:Label>
     </div>
    <div class="col-sm-7">
         <asp:TextBox ID="descreduct" runat="server" Width="560px" class="form-control" AutoComplete="off" BorderColor="#C48A05" BorderWidth="2px" Placeholder="Description"></asp:TextBox>
     </div>
     <div class="col-3">
         <asp:TextBox ID="txtredc" runat="server" Width="246px" class="form-control" AutoComplete="off" BorderColor="#C48A05" BorderWidth="2px"></asp:TextBox>
     </div>
     </div>
     <br />
     <div class="row">
     ...
     <div class="col-sm-7">
         <asp:TextBox ID="descadd" runat="server" Width="560px" class="form-control" AutoComplete="off" BorderColor="#C48A05" BorderWidth="2px" Placeholder="Description"></asp:TextBox>
     </div>
     <div class="col-3">
         <asp:TextBox ID="txtadd" runat="server" Width="248px" class="form-control" AutoComplete="off" BorderColor="#C48A05" BorderWidth="2px"></asp:TextBox>
     </div>
     </div>
     <br />
     <div class="row">
    ...
    <div class="col-sm-5"></div>
    <div class="col-sm-2">
        <asp:Button ID="BtnPrint" runat="server" Text="Calculate" class="btn btn-primary" OnClick="BtnPrint_Click"/>&nbsp;&nbsp;
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Print" class="btn btn-success" OnClick="Button1_Click" />
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-7">
            <a href="billselection.aspx"><p>List</p></a>
        </div>
    </div>
    </div>
    </div>
