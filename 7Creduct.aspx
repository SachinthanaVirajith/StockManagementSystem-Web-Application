<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="7Creduct.aspx.cs" Inherits="TCPStockManagementSystem._7Creduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-sm"  style="margin-top:5px">
        ...
        <h5  class="card-header">Add number of kilo's used for daily production</h5>
                        <h1 style="font-weight: bolder; text-transform: uppercase; color: #000000;">7C
            </h1>
            <br />
            <div class="card" style="margin: -9px; padding: 8px; background-color: #FFFFCC" >
             ...
             <div class="row">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="TextBox2" runat="server" Visible="True" Width="125px" AutoComplete="off" BorderColor="#C48A05" BorderWidth="2px" ReadOnly="True"></asp:TextBox>
                </div>
                 <div class="col-md-3">
                    <asp:Label ID="Label2" runat="server" Text="Non-Wash:" Font-Size="Large" Font-Bold></asp:Label>
                </div>
                <div class="col-md-3">
                    <asp:TextBox ID="TextBox3" runat="server" Visible="True" Width="125px" AutoComplete="off" BorderColor="#C48A05" BorderWidth="2px" ReadOnly="True"></asp:TextBox>
                </div>
            </div>
                </div>
                    </div>
