    ...
    <div class="container">
        <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:TextBox ID="sellerNametxt" runat="server" class="form-control" BorderColor="Maroon" required></asp:TextBox>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <asp:TextBox ID="vehicleNumtxt" runat="server" class="form-control" BorderColor="Maroon" required></asp:TextBox>
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="container">
                            <div class="card" style="background-color: #C0C0C0">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <asp:Label ID="Label2" runat="server" Text="Label">Full Weight</asp:Label>    
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:Label ID="Label3" runat="server" Text="Label">Sample Weight</asp:Label>   
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:Label ID="Label4" runat="server" Text="Label">Sample Wastage</asp:Label>   
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:Label ID="Label5" runat="server" Text="Sand Weight"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="fullWeighttxt" runat="server" class="form-control form-control-sm" BorderColor="Maroon" required></asp:TextBox>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="sampleWeighttxt" runat="server" class="form-control form-control-sm" BorderColor="Maroon" required></asp:TextBox>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="sampleWastagetxt" runat="server" class="form-control form-control-sm" BorderColor="Maroon" required></asp:TextBox>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="sandWeighttxt" runat="server" class="form-control form-control-sm" BorderColor="Maroon" required></asp:TextBox>
                                        </div>                  
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="netWeighttxt" runat="server" class="form-control" Font-Bold="true" ReadOnly="true" BorderColor="Maroon"></asp:TextBox>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <asp:Label ID="Label7" runat="server" Text="Coir Weight"></asp:Label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
